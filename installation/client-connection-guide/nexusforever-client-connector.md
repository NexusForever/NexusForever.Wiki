...
![Client Connector download from GitHub release page.](<../../.gitbook/assets/image (3) (1) (1).png>)

Copy the ClientConnector to the Client64 directory found in the root WildStar client directory.

![Client64 directory which is found in the WildStar client directory.](<../../.gitbook/assets/image (2) (1) (1).png>)
...
![127.0.0.1 entered for a local NexusForever installation.](<../../.gitbook/assets/image (1) (1) (1).png>)

You should now, this is the language of your WildStar client, for English enter en and press enter.

![en entered for a English WildStar client.](<../../.gitbook/assets/image (5) (1).png>)
...
![WildStar client main menu showing connected server.](<../../.gitbook/assets/image (4) (1) (1).png>)
