...
NexusForever database clone guides are provdied for both Windows and Linux.
...
{% hint style="info" %}
The `C:\nexusforever-database` folder can be substituted for another path although the guide will assume that this default directory is use
{% endhint %}
...
{% hint style="info" %}
The `/opt/nexusforever-database` folder can be substituted for another path although the guide will assume that this default directory is use
{% endhint %}
