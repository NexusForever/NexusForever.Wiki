...
Once MySQL and RabbitMQ have successfully started, .NET Aspire will start the database-migrations helper to setup and configure the databases.
...
Once the NexusForever account has been successfully created the database-migration helper will apply the NexusForever database dumps.
