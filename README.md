...
If you are wanting to setup your own NexusForever server checkout the server installation guides for both [Windows](installation/server-guide/server-installation/server-install-guide-windows/) and [Linux](installation/server-guide/server-installation/server-install-guide-linux/).
